...
const HomePage = () => {
  return(
    <main className="flex min-h-screen flex-col gap-4 items-center p-4 pt-20 md:p-24 bg-backgroundColor">
      ...
      <div className="flex flex-col gap-2 items-center rounded border border-primaryColor w-full">
        <div className="relative flex flex-row gap-2 items-center justify-center w-full pl-2 pr-2 pt-2 ">
          <Image
            ...
            priority
          />
          <p className="text-primaryColor text-lg text-bold">Hero Journey</p>
          <Image
            src="/pen-add.svg"
            alt="Hero Icon"
